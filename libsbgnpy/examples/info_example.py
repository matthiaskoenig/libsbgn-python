# -*- coding: utf-8 -*-
"""
Display information from SBML files.

Use python bindings to SBGN (generated by generateDS) to interact with SBGN maps.
"""
...
# sbgn and map
sbgn = libsbgn.parse(os.path.join(dir, f_in))
map = sbgn.get_map()
